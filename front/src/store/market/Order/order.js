...
const actions = {
  actOrder_List_Items({ commit }, date) {
    ...
    axios({
      url: "http://localhost:6666/order/list",
      method: "get",
  ...
  actOrder_Review_Items({ commit }, data) {
    if (data.dates.length > 1)
      axios({
        url: "http://localhost:6666/order_review/reviews/list",
        method: "get",
        withCredentials: true,
        params: {
          date1: data.dates[0],
  ...
  actOrder_Review_answers({ commit }, data) {
    axios({
      url: `http://localhost:6666/order_review/answer/${data.review_id}`,
      method: "get",
      withCredentials: true,
      params: {
        answer: data.answer,

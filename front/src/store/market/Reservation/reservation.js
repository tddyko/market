...
const actions = {
  actReserve_Review_Items({ commit }, data) {
    if (data.dates.length > 1)
      axios({
        url: "http://localhost:6666/reseve_review/reviews/list",
        method: "get",
  ...
  actReserve_List_Items({ commit }, date) {
    ...
    axios({
      url: "http://localhost:6666/reservation/list",
      method: "get",
      withCredentials: true,
      params: {
        dateValue: date,
  ...
  actReserve_Review_answers({ commit }, data) {
    axios({
      url: `http://localhost:6666/reseve_review/recoment/${data.review_id}`,
      method: "get",
      withCredentials: true,
      params: {
        answer: data.answer,

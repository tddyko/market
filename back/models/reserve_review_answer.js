module.exports = (sequelize, DataTypes) => {
  const Reserve_review_answer = sequelize.define(
  ...
  Reserve_review_answer.associate = (models) => {
    Reserve_review_answer.belongsTo(models.Market, {
      foreignKey: "market_id",
      targetKey: "market_id",
    });
    Reserve_review_answer.belongsTo(models.Member, {
      foreignKey: "member_id",
      targetKey: "member_id",
    });
    Reserve_review_answer.belongsTo(models.Reserve_review, {
      foreignKey: "reserve_review_id",
      targetKey: "reserve_review_id",
    });
  };

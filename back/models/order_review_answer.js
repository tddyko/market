module.exports = (sequelize, DataTypes) => {
  const Order_review_answer = sequelize.define(
    "Order_review_answer",
    {
  ...
  Order_review_answer.associate = (models) => {
    Order_review_answer.belongsTo(models.Market, {
      foreignKey: "market_id",
      targetKey: "market_id",
    });
    Order_review_answer.belongsTo(models.Member, {
      foreignKey: "member_id",
      targetKey: "member_id",
    });
    Order_review_answer.belongsTo(models.Order_review, {

module.exports = (sequelize, DataTypes) => {
    const Market_noti_img = sequelize.define("Market_noti_img", {
        market_noti_img_id: {
            type: DataTypes.UUID,
    ...
    Market_noti_img.associate = models => {
        Market_noti_img.belongsTo(models.Market_inform, {foreignKey: 'market_inform_id', targetKey: 'market_inform_id'});
    };

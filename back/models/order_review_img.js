module.exports = (sequelize, DataTypes) => {
    const Order_review_img = sequelize.define("Order_review_img", {
        Order_review_img_id: {
            type: DataTypes.UUID,
    ...
    Order_review_img.associate = models => {
        Order_review_img.belongsTo(models.Order_review, {foreignKey: 'order_review_id', targetKey: 'order_review_id'});
    };

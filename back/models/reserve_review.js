module.exports = (sequelize, DataTypes) => {
  const Reserve_review = sequelize.define(
    "Reserve_review",
    {
      reserve_review_id: {
        type: DataTypes.UUID,
  ...
  Reserve_review.associate = (models) => {
    Reserve_review.hasMany(models.Reserve_review_img, {
      foreignKey: "reserve_review_id",
      sourceKey: "reserve_review_id",
      onDelete: "cascade",
      hooks: true,
    });
    Reserve_review.hasOne(models.Reserve_review_answer, {
      foreignKey: "reserve_review_id",
      sourceKey: "reserve_review_id",
      onDelete: "cascade",
      hooks: true,
    });
    Reserve_review.belongsTo(models.Member, {
      foreignKey: "member_id",
      targetKey: "member_id",
    });
    Reserve_review.belongsTo(models.Market, {
      foreignKey: "market_id",
      targetKey: "market_id",
    });
    Reserve_review.belongsTo(models.Reservation, {

module.exports = (sequelize, DataTypes) => {
  ...
  Member.associate = (models) => {
    ...
    Member.hasMany(models.Order_review, {
      foreignKey: "member_id",
      sourceKey: "member_id",
      onDelete: "cascade",
      hooks: true,
    });
    Member.hasMany(models.Order_review_answer, {
      foreignKey: "member_id",
      sourceKey: "member_id",
      onDelete: "cascade",
      hooks: true,
    });
    Member.hasMany(models.Reserve_review, {
      foreignKey: "member_id",
      sourceKey: "member_id",
      onDelete: "cascade",
      hooks: true,
    });
    Member.hasMany(models.Reserve_review_answer, {
      foreignKey: "member_id",
      sourceKey: "member_id",
      onDelete: "cascade",
      hooks: true,

module.exports = (sequelize, DataTypes) => {
  const Market_inform = sequelize.define(
    "Market_inform",
    {
      market_inform_id: {
        type: DataTypes.UUID,
    ...
    },
    {
      ...
      modelName: "Market_inform", // sequelize 에서 사용되는 테이블이름(node.js 코딩에서 활용)
  ...
  Market_inform.associate = (models) => {
    Market_inform.hasMany(models.Market_inform_img, {
      foreignKey: "market_inform_id",
      sourceKey: "market_inform_id",
      onDelete: "cascade",
      hooks: true,
    });
    Market_inform.hasMany(models.Market_inform_holiday, {
      foreignKey: "market_inform_id",
      sourceKey: "market_inform_id",
      onDelete: "cascade",
      hooks: true,
    });
    Market_inform.belongsTo(models.Market, {
